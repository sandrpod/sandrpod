...
> English version: [MCP_AUTH.md](MCP_AUTH.md)
...
`X-Sandrpod-Token`。历史见 [design/mcp-auth-header-conflict-fix.md](design/mcp-auth-header-conflict-fix.md)。
...
- [design/mcp-auth-header-conflict-fix.md](design/mcp-auth-header-conflict-fix.md) — 两 header 方案的由来
